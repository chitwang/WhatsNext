...
import src1 from './logo1.png';

export default function Sidebar() {

    const style1={width: "auto"};
    const style2={display: "flex", justifyContent: "space-between", flexDirection: "column" };
    const style3={fontSize: "10px"};
    return (
        <>
            <nav
                id="sidebarMenu"
            ...
            >
                <div className="position-sticky pt-3 sidebar-sticky" style={style2}>
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <NavLink exact className="nav-link" activeClassName="active" to="/myevents">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
